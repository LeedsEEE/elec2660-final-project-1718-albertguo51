...
- (instancetype)init
{
    ...
    if (self) {
        ...
        //2nd destination pl2 (LAX Tom Bradley International Terminal (LAX Terminal B))
        self.sfplaces = [NSMutableArray array];
        Places *pl2 = [[Places alloc] init];
        pl2.name = @"LAX Tom Bradley International Terminal (LAX Terminal B) ";
        ...
        pl14.address =@"50 Hagiwara Tea Garden Dr, San Francisco, CA 94118";
        ...
        pl15.address =@"75 Hagiwara Tea Garden Dr, San Francisco, CA 94102";
        ...
        pl19.address =@"1600 Amphitheatre Pkwy, Mountain View, CA 94043";
        pl19.openhr = @"24/7";
        ...
        pl22.openhr = @"Weekdays: 9:00 - 21:00; Sat: 9:00 - 20:00; Sun: 10:00 - 19:00";
        ...
        pl24.openhr = @"24/7";
        pl24.coordination = CLLocationCoordinate2DMake(36.361475, -121.856261);
